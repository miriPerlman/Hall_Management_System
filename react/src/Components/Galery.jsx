...
// import img19 from '../assets/imges/galery/27.png';
...
// Images mapping by event type (key matches the event param)
const imagesByEvent = {
...
const Galery = () => {
  ...
  // Get event type from URL, default: wedding
  ...
  return (
    <ThemeProvider theme={theme}>
      <Box sx={{ p: 4 }}>
        ...
        <Box style={{ display: 'flex', flexWrap: 'wrap', gap: theme.spacing(2), marginTop: theme.spacing(20) }}>
